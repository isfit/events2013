class Event < ActiveRecord::Base
  ...
  has_attached_file :image, :styles => { :cover => "920x420<", :square => "500x500>" }, :convert_options => { :all => "-quality 75" }
  has_attached_file :image_front, :styles => { :cover => "920x220<", :square => "500x500>" }, :convert_options => { :all => "-quality 75" }
